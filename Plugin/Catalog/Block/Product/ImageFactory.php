...
class ImageFactory
{
     ...
     * @return ImageBlock
     */
    public function aroundCreate(CatalogImageFactory $catalogImageFactory, callable $proceed, Product $product, string $imageId, $attributes = null)
    {
        ...
        if (!is_array($attributes) || !class_exists('\Magento\Catalog\Model\Product\Image\ParamsBuilder')) {
            return $imageBlock;
        }
